...
function TemplateOne() {
  ...
  const base: TSResume.Base = useAppSelector((store) => store.resume.base);
  const resumeToolbarKeys: string[] = useAppSelector((store) => store.template.resumeToolbarKeys);

  console.log(base, resumeToolbarKeys)
